...
> **Week-by-week status at a glance: [`outputs/STATUS.md`](outputs/STATUS.md)** — which Definitions of Done were met, which failed, and which weeks are still empty scaffolding.
